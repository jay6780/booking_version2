package com.hair.booking.activity.Fragments.history;
...
import com.hair.booking.activity.tools.adapter.BookingAdapter;
...
public class CancelFragment extends Fragment {
    ...
    private void fetchBookIds(List<String> chatIds) {
        ...
        DatabaseReference mybookRef = database.getReference("Cancelbook");
        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
