...
public class MessageAdapter3 extends RecyclerView.Adapter<MessageAdapter3.MessageViewHolder> {
    ...
    public MessageAdapter3(ArrayList<Message> messageList, Context context) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MessageAdapter3.MessageViewHolder holder, int position) {
