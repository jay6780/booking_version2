...
public class HistoryBookFragment_event extends Fragment {
    private RecyclerView bookrecycler;
    private BookingAdapter_event bookingAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        bookingAdapter = new BookingAdapter_event(bookingList, getContext());
