...
public class portfolioEventFragment extends Fragment {

    private DatabaseReference serviceRef,guessRef;
    private portfolio_eventAdapter serviceAdapter;
    ...
    private String TAG = "portfolioEventFragment";
    ...
    private void fetchServices(String gender) {
        ...
        serviceRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                serviceAdapter = new portfolio_eventAdapter(services, getContext());
