...
import com.hair.booking.activity.MainPageActivity.profile.providerProfile;
import com.hair.booking.activity.MainPageActivity.profile.providerProfile3;
...
public class addReviewActivity2 extends AppCompatActivity {
    ...
    private void initSavedata() {
        addimmage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PhotoPicker.startPhotoPickerForResult(addReviewActivity2.this, REQUEST_CODE_PHOTO_PICKER);
            }
        });
    ...
    private void saveReviewData() {
        ...
        dialogPlus = new Dialog().loadingDialog(addReviewActivity2.this);
        dialogPlus.show();

        if (imageUri != null) {

            uploadImageToStorage(new addReviewActivity2.ImageUploadCallback() {
                @Override
                ...
                public void onFailure(Exception e) {
                    dialogPlus.dismiss();
                    Toast.makeText(addReviewActivity2.this, getString(R.string.errorupload), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
    ...
    private void uploadImageToStorage(final addReviewActivity2.ImageUploadCallback callback) {
    ...
    private void saveReviewToDatabase(String imageUrl, String content, float rating, String userimage) {
        ...
        reviewRef.setValue(reviewData)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(addReviewActivity2.this, getString(R.string.review_success), Toast.LENGTH_SHORT).show();
                    finish();
                    dialogPlus.dismiss();
                })
                .addOnFailureListener(e -> {
                    dialogPlus.dismiss();
                    Toast.makeText(addReviewActivity2.this, getString(R.string.review_failed), Toast.LENGTH_SHORT).show();
                });
    }
