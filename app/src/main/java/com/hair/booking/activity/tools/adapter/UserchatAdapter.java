...
public class UserchatAdapter extends RecyclerView.Adapter<UserchatAdapter.ProviderViewHolder> {
    private ArrayList<Usermodel> providerList;
    private Context context;
    private DatabaseReference databaseReference,chatreference;

    public UserchatAdapter(ArrayList<Usermodel> providerList, Context context) {
