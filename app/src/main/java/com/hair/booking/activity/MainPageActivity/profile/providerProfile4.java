...
public class providerProfile4 extends AppCompatActivity {
    ...
    private void selectTab(TextView selectedTab) {
        ...
        spannable.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.maroon)), 0, spannable.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public void onBackPressed(){
        Intent back = new Intent(getApplicationContext(), hmua.class);
        startActivity(back);
        overridePendingTransition(0,0);
        finish();
    }
