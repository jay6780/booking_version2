...
public class Admin_summary extends AppCompatActivity {
    ...
    private void initRecentpackages(String serviceName) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("RecentAvailed_event").child(uid);
