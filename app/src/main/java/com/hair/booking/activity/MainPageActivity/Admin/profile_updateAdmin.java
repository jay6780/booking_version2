...
import com.hair.booking.activity.MainPageActivity.Guess.profile_update;
...
public class profile_updateAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detector = new FaceDetector.Builder(profile_updateAdmin.this)
        ...
        if (intent != null) {
            ...
            addressUser.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dialog.updateLocation(profile_updateAdmin.this, image, address, username, name, phone, email);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isImagePicked && !isFaceDetected) {
                    Toast.makeText(profile_updateAdmin.this, "No face detected. Please select a valid image.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (isImagePicked) {
                    ...
                    if (imageUri != null) {
                        progressDialog = new ProgressDialog(profile_updateAdmin.this);
                        ...
                        imageRef.putFile(imageUri)
                                                ...
                                                userRef.child("image").setValue(imageUrl)
                                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                            ...
                                                            public void onSuccess(Void aVoid) {
                                                                ...
                                                                Toast.makeText(profile_updateAdmin.this, "Profile updated successfully", Toast.LENGTH_SHORT).show();
                                                                Intent intent = new Intent(profile_updateAdmin.this, newHome.class);
                                                        ...
                                                        .addOnFailureListener(new OnFailureListener() {
                                                            ...
                                                            public void onFailure(@NonNull Exception e) {
                                                                ...
                                                                Toast.makeText(profile_updateAdmin.this, "Failed to update profile", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                            }
                                        });
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        ...
                                        Toast.makeText(profile_updateAdmin.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    } else {
                        Toast.makeText(profile_updateAdmin.this, "Please select an image", Toast.LENGTH_SHORT).show();
                    }
                } else {
        ...
        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(profile_updateAdmin.this);
        builder.setTitle("Select Image")
                .setItems(new CharSequence[]{"Pick Photo", "Capture Image"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0) {
                            isFaceDetected = true;
                            PhotoPicker.startPhotoPickerForResult(profile_updateAdmin.this, REQUEST_CODE_PHOTO_PICKER);
                        } else if (which == 1) {
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(profile_updateAdmin.this,
    ...
    private void showNoFaceDetectedDialog() {
        Dialog dialog = new Dialog();
        dialog.shownoface(profile_updateAdmin.this);
        profileImageView.setImageResource(R.mipmap.man);
    }
