...
public class AddEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("Event_pics");
        ...
        name.setText(R.string.add_event);
    ...
    private void initClickers() {
        ...
        saved.setOnClickListener(view -> {
            if (imageUri != null) {
                ...
                Toast.makeText(AddEvent.this, R.string.selectimg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PHOTO_PICKER) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, R.string.crop_failed+ cropError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveServiceData(Uri imageUri) {
        ...
        if (!serviceName.isEmpty() && servicePrice > 0 && imageUri != null) {
            ...
            Toast.makeText(this, R.string.validService, Toast.LENGTH_SHORT).show();
        }
    }
        ...
        try {
            ...
            uploadTask.addOnSuccessListener(taskSnapshot ->
                    fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        dialogPlus.dismiss();
                        Toast.makeText(AddEvent.this, R.string.failedUrl, Toast.LENGTH_SHORT).show();
                    })
            ).addOnFailureListener(e -> {
                dialogPlus.dismiss();
                Toast.makeText(AddEvent.this, R.string.failedimgupload, Toast.LENGTH_SHORT).show();
            });

        } catch (IOException e) {
            dialogPlus.dismiss();
            Toast.makeText(AddEvent.this, "Failed to get image", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void saveServiceToDatabase(String serviceName, int servicePrice, String imageUrl, String gender) {
        ...
        if (serviceId != null) {
            databaseReference.child(serviceId).setValue(service)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(AddEvent.this, "Failed to add service", Toast.LENGTH_SHORT).show());
        }
    }
