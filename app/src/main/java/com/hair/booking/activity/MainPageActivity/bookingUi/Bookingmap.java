package com.hair.booking.activity.MainPageActivity.bookingUi;
...
public class Bookingmap extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fusedLocationClient = LocationServices.getFusedLocationProviderClient(Bookingmap.this);
        ...
        if (currentUser != null) {
            ...
            loadPackagesAndUserInfo(currentUserId, time, heads, cash, serviceName, price, date);
        }
        initShowbook();
    ...
    private void loadPackagesAndUserInfo(String currentUserId, String time, String heads, String cash, String serviceName, String price, String date) {
        ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading...");
        progressDialog.setCancelable(false);
        progressDialog.show();
        initRecentpackages(serviceName);
        ...
        transactionMapRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    String latLngString = destinationLocation.latitude + "," + destinationLocation.longitude;
                    SPUtils.getInstance().put(AppConstans.laslocation, latLngString);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Bookingmap.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_REQUEST_CODE);
            return;
        }
    ...
    private void requestAndSetUserLocation() {
        ...
        fusedLocationClient.getLastLocation()
                .addOnSuccessListener(Bookingmap.this, location -> {
                    if (location != null) {
    ...
    private void geocodeLocation(LatLng latLng) {
        Geocoder geocoder = new Geocoder(Bookingmap.this, Locale.getDefault());
        try {
    ...
    private void fetchUserDetailsAndAddMarker(LatLng userLocation) {
        ...
        if (currentUser != null) {
            ...
            DatabaseReference userRef = FirebaseDatabase.getInstance().getReference("Guess").child(userId);
    ...
    private void checkIfUserIsGuess(String userId, String time, String heads, String cash, String serviceName, String price, String date) {
        DatabaseReference guessRef = FirebaseDatabase.getInstance().getReference("Guess").child(userId);
        guessRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    try {
                        // Attempt to deserialize the service names list
                        ...
                        if (serviceNamesList == null || serviceNamesList.isEmpty()) {
                            // Fallback to RecentPackage if serviceNamesList is null or empty
                        ...
                        String latlang = SPUtils.getInstance().getString(AppConstans.laslocation, "");

                        // Generate a Google Maps link if no direct location link exists
                        if (locationLink.isEmpty() && !latlang.isEmpty()) {
                        ...
                        Log.e(TAG, "Error deserializing serviceNamesList or RecentPackage: " + e.getMessage(), e);
                    }
                }
            }
