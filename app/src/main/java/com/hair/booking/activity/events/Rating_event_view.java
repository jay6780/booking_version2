...
public class Rating_event_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reviewAdapter = new ReviewAdapter(reviewList, Rating_event_view.this);
        commentRecycler.setLayoutManager(new LinearLayoutManager(Rating_event_view.this));
