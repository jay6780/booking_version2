...
public class Bookingmap_Event extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bookingmap_event);
        ...
        fusedLocationClient = LocationServices.getFusedLocationProviderClient(Bookingmap_Event.this);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Bookingmap_Event.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_REQUEST_CODE);
            return;
        }
    ...
    private void requestAndSetUserLocation() {
        ...
        fusedLocationClient.getLastLocation()
                .addOnSuccessListener(Bookingmap_Event.this, location -> {
                    if (location != null) {
    ...
    private void geocodeLocation(LatLng latLng) {
        Geocoder geocoder = new Geocoder(Bookingmap_Event.this, Locale.getDefault());
        try {
    ...
    private void fetchUserDetailsAndAddMarker(LatLng userLocation) {
        ...
        if (currentUser != null) {
            ...
            DatabaseReference userRef = FirebaseDatabase.getInstance().getReference("Guess").child(key);
    ...
    private void loadAdminMarker(Usermodel admin, LatLng userLocation) {
        ...
        try {
            ...
            if (addresses != null && !addresses.isEmpty()) {
                ...
                Glide.with(Bookingmap_Event.this)
                        .asBitmap()
                        .load(admin.getImage())
                        .override(100, 100)
