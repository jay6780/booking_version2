...
import com.hair.booking.activity.tools.adapter.ServiceNameAdapter;
...
public class Event_summary extends AppCompatActivity {
    ...
    private String TAG = "Event_summary";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "snapshotkey: " + snapshotkey);
    ...
    private void initRecentpackages(String key) {
        String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        Log.d(TAG,"uid: "+uid);
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("SummaryEvent").child(uid);

        databaseReference.orderByChild("snapshotKey").equalTo(key)
