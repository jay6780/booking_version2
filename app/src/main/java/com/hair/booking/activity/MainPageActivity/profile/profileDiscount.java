package com.hair.booking.activity.MainPageActivity.profile;
...
import com.hair.booking.activity.MainPageActivity.maps.MapsActivity2;
...
import com.hair.booking.activity.tools.adapter.ServiceProviderAdapter;
import com.yariksoffice.lingver.Lingver;

import java.util.Arrays;
import java.util.Locale;

public class profileDiscount extends AppCompatActivity {
    ...
    private String servicename,discount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SPUtils.getInstance().put(AppConstans.discount,discount);
        SPUtils.getInstance().put(AppConstans.discountservicename,servicename);
    ...
    private void inititle() {
        DatabaseReference databaseReference2 = FirebaseDatabase.getInstance().getReference("ADMIN").child(key);
        ...
        databaseReference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (user != null) {
                               profiletxt.setText(getString(R.string.eventTitle));
                                String selectlang = SPUtils.getInstance().getString(AppConstans.selectLang);
                                if(selectlang.equals("en")){
                                    profiletxt.setTextSize(18);
                                }else{
                                    profiletxt.setTextSize(15);
                                }
                            }
                        }
                    }
                ...
                databaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (user != null) {
                                String selectlang = SPUtils.getInstance().getString(AppConstans.selectLang);
                                profiletxt.setText(getString(R.string.hmudetails));
                                if(selectlang.equals("en")){
                                    profiletxt.setTextSize(18);
                                }else{
                                    profiletxt.setTextSize(15);
