...
import com.hair.booking.activity.tools.adapter.BookingAdapters;
import com.hair.booking.activity.tools.adapter.BookingAdapters_admin;

public class history_book_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookingAdapters = new BookingAdapters_admin(getSupportFragmentManager());
    ...
    private void gotochat() {
        Intent gotochat = new Intent(getApplicationContext(), UserChat.class);
